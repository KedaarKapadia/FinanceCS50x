...
def buy():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            ...
            return apology("Invalid Symbol bozo")
        ...
        if shares <= 0:
            return apology("Shares must be an integer bozo!")
        ...
        if cash < total_price:
            return apology("Not enough money bozo!")
        else:
...
def quote():
    ...
    if request.method == "POST":
        ...
        if not symbol:
            return apology("Enter a symbol bozo!")
...
def register():
    ...
    if request.method == "POST":
        ...
        if password != confirmation:
            return apology("Passwords don't match bozo!")
        ...
        try:
            ...
            return apology("Username has already been registered bozo")
    else:
...
def sell():
    ...
    if request.method == "POST":
        ...
        if shares <= 0:
            return apology("Shares must be a positive number bozo!")
        ...
        if shares_owned < shares:
            return apology("You don't have enough shares bozo!")
            
        if shares_owned == 0 and shares > shares_owned:
